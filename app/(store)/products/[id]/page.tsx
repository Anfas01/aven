          ...
          <section className="space-y-8">
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-zinc-500">
                  Every payment is securely processed
                  through Stripe using industry-standard
                  encryption.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-zinc-500">
                  ...
                  worldwide with trusted shipping
                  partners.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-7 text-zinc-500">
                  Return your order within 30 days if it
                  isn&apos;t exactly what you expected.
                </p>
              </div>
            </div>
          </section>

          <section className="mt-16 space-y-10 border-t border-zinc-200 pt-12">
            <div>
              ...
              <p className="mt-4 max-w-2xl leading-8 text-zinc-600">
                ...
                exceptional attention to detail, this
                product is designed to elevate your
                everyday experience while maintaining
                timeless aesthetics and lasting
                durability.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl leading-8 text-zinc-600">
                ...
                days. We offer fast worldwide shipping
                and hassle-free returns within 30 days.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 max-w-2xl leading-8 text-zinc-600">
                Every order is processed securely by
                Stripe using industry-leading
                encryption.
              </p>
            </div>
          </section>
